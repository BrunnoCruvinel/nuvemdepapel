<section id="menu">
    <div class="container">
            ...
            <div class="col-md-10 col-sm-10 col-xs-10">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <nav class="menu-items menu-destaque" >

                            <div class="row botao-menu-responsivo text-right">
                                <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                    <a href="javascript:void(0)"><img src="<?php echo bloginfo("template_directory") ?>/img/logo.png" alt="" class="logo" style="width: 48px"></a>
                                </div>
                                <!--div class="col-md-8 col-sm-8 ol-xs-8">
		...
		<div class="container">
			<div class="row">
				<nav id="menuMobile" class="col-md-12 col-sm-12 col-xs-12 np" style="display: none;">
